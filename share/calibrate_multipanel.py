...
def calibrate_instrument_from_sx(
    ...
    if sim_only:
        ...
        instr.beam.energy = cnst.keVToAngstrom(fit_params[0])
        instr.oscillation_stage.chi = fit_params[1]
        instr.oscillation_stage.tvec = fit_params[2:5]
        ii = 11
...
if override_grain_params:
    ...
    instr_cfg = yaml.load(open(root_cfg_dict['instrument'], 'r'))
    try:
...
if overwrite_parfile:
    output_name = root_cfg_dict['instrument']
